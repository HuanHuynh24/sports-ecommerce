...
/* =========================================================================
 * 3. COMPONENT CON: QUANTITY CONTROL (GIỮ NGUYÊN)
 * ========================================================================= */
            ...
            {!isEmpty ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-xl">
                ...
                <p className="text-gray-500 mb-6 text-center max-w-xs">
                  Chưa có sản phẩm nào. Hãy tìm kiếm sản phẩm yêu thích của bạn
                  nhé!
                </p>
                <Link
                  href="/"
                  className="px-6 py-2.5 bg-gray-900 dark:bg-white text-white dark:text-black font-bold rounded-full hover:opacity-90 transition-all"
                >
                  Tiếp tục mua sắm
                </Link>
              </div>
            ...
            <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
              ...
              {selectedItems.length > 0 && (
                <div className="mb-4">
                  ...
                  {/* SCROLLABLE LIST */}
                  <div
                    className="max-h-[240px] overflow-y-auto pr-2 space-y-3 
              ...
              <button
                onClick={handleCheckout} //<--- 4. Gắn hàm handleCheckout (Desktop)
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1a1a1a] border-t border-gray-200 dark:border-gray-800 p-4 pb-safe z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-1 justify-end">
            ...
            <button
              onClick={handleCheckout} //<--- 5. Gắn hàm handleCheckout (Mobile)
              disabled={selectedCount === 0}
